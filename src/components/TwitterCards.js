...
const Card = ({content}) =>
  <CardStyle>
    ...
    <a target='_blank' href={`https://twitter.com/intent/tweet?text=${content}%20${typeof window !== 'undefined' && window.location.href}%20%23getTheSwitch`}><CardButton>Tweet</CardButton></a>
  </CardStyle>
;
